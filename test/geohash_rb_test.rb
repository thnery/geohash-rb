  ...
  def test_decode
    {
      ...
      assert_equal GeohashRb.decode(hash), latlng
    end
  end
  ...
  def test_encode
    {
      ...
      assert_equal GeohashRb.encode(latlng[0], latlng[1], hash.length), hash
    end
  end
  ...
  def test_neighbors
    {
      ...
      assert_equal GeohashRb.neighbors(geohash).sort, neighbors.sort
    end
  end
  ...
  def test_adjacent
    {
      ...
      assert_equal GeohashRb.adjacent(*position), hash
    end
  end
